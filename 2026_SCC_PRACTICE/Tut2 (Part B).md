...
1. **Clone the btop repository:** Open a terminal and navigate to a suitable location on your machine. Then, execute the following command:
   ```bash
   git clone -r https://github.com/aristocratos/btop.git
   ```
...
Submit the following materials as your tutorial:
1. The screenshot of the running btop application in another folder on your team's repository.
...
This will also come in handy in understanding your last tutorial before your teams will need to submit applications to the selection round of the CHPC SCC. 
